...
// === GRADIENT BUTTON COMPONENT (FIXED PROPS DEFINITION) ===
const GradientButton = ({
  href,
  children, // Now 'children' is correctly defined here
  className = '',
  target = '_blank',
}: {
  href: string
  ...
  >
    ...
    */}
    ...
    >
      {children} {/* This line now works because children is defined above */}
    </span>
  </a>
)
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            ...
            <div className="rounded-lg bg-tonr-gradient p-[1.5px]">
              <div className="h-full w-full rounded-md bg-dark-900 p-6 text-center">
                ...
                <p className="mt-2 text-3xl font-bold text-light-100">Locked</p>
              </div>
            </div>
          </div>
                ...
                <div className="mt-3 flex flex-col items-center gap-4 sm:flex-row">
                  ...
                  <button
                    ...
                    className={`flex w-full items-center justify-center gap-2 rounded-lg px-4 py-2 font-semibold transition sm:w-auto ${
                      copiedAddress === 'evm'
                        ? 'bg-tonr-cyan text-black'
                        : 'bg-dark-900 text-light-100 hover:bg-opacity-75'
                    }`}
                  >
                    {copiedAddress === 'evm' ? (
                      <>
