  ...
  return (
    <div className="flex min-h-screen flex-col items-center p-6 md:p-12 bg-dark-950 text-light-100">
      <main className="flex w-full max-w-5xl flex-col">
        ...
        {/* === ABOUT SECTION === */}
        <section className="mx-auto w-full max-w-2xl text-center"> {/* Removed py-24 */}
          <h2 className="mb-4 text-2xl font-bold text-light-100">What Is TONR?</h2>
          <div className="space-y-4 text-lg text-light-400">
            <p>TONR is the genesis meme of the PRINTR ecosystem — the original ink in the tank. Created as the first official beta coin, TONR exists to mark the beginning of the PRINTR era.</p>
            <p>It’s not just a coin; it’s a historical artifact — the first stain on the blank page before the bull run begins.</p>
            <h3 className="pt-4 text-xl font-semibold text-light-100">Why It Matters:</h3>
            <p>When PRINTR starts gaining momentum, traders will look for the first mover — the earliest coin tied to its launch. That’s TONR.</p>
            <p className="font-semibold text-light-100">The OG. The first print. The proof of concept that’s destined to become collectible history in memecoin culture.</p>
          </div>
        </section>
        ...
        <section className="mx-auto w-full max-w-2xl text-center"> {/* Removed py-24 */}
          <h2 className="mb-4 text-2xl font-bold text-light-100">The Vision</h2>
          <div className="space-y-4 text-lg text-light-400">
            <h3 className="pt-4 text-xl font-semibold text-light-100">From One Print to a Thousand Chains.</h3>
            <p>PRINTR is building the world’s first multi-chain memecoin launchpad, where tokens can be minted and deployed across ecosystems without barriers. TONR positions itself as the core meme identity of this ecosystem — the original ink that powered the printer before it became a factory.</p>
            <p>As liquidity rotates from outdated platforms like Pump.fun, PRINTR will become the new global mint for memes — and TONR will sit at the heart of that story.</p>
            <p className="italic font-semibold text-light-100">The first test print always becomes the rarest one.</p>
          </div>
        </section>
        ...
        <section className="mx-auto w-full max-w-2xl text-center"> {/* Removed py-24 */}
           <h2 className="mb-4 text-2xl font-bold text-light-100">How to Buy</h2>
          <div className="space-y-4 text-lg text-light-400">
            ...
            <p className="pt-4 font-semibold text-light-100">
              Pro Tip:<br />
              <span className="font-normal text-light-400">Early holders of TONR aren’t just traders — they’re ink suppliers for the entire PRINTR machine.</span>
            </p>
          </div>
        </section>
        ...
        {/* === NEW SECTION: MEME ZONE === */}
         <section className="mx-auto w-full max-w-2xl text-center"> {/* Removed py-24 */}
           <h2 className="mb-4 text-2xl font-bold text-light-100">Meme Zone</h2>
          <div className="space-y-4 text-lg text-light-400">
            <p>TONR isn’t a token — it’s a lifestyle for the overworked, underpaid office printer of the crypto world.</p>
            <p className="font-semibold text-light-100">Our ink doesn’t dry. Our charts don’t sleep.</p>
            <p className="italic font-semibold text-light-100">We don’t rug — we smudge.</p>
            <h3 className="pt-4 text-xl font-semibold text-light-100">Join the TONR movement:</h3>
            <ul className="list-disc list-inside space-y-1 text-left sm:text-center">
             ...
             <h3 className="pt-4 text-xl font-semibold text-light-100">Catchphrases:</h3>
